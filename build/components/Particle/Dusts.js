...
var Dust = function () {
  ...
  _createClass(Dust, [{
    ...
    value: function createOne(x, y, type, angle) {
      ...
      var xvel, yvel;
      var xSpeed = Math.cos(angle + Math.PI * 1.5) * getRandom(type.initialXSpeed[0] * 100, type.initialXSpeed[1] * 100) / 100;
      var ySpeed = Math.sin(angle - Math.PI * 1.5) * getRandom(type.initialYSpeed[0] * 100, type.initialYSpeed[1] * 100) / 100;
