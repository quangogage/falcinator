...
import { LoadLose, UpdateLose, hasLost } from './Lose/Lose';
import LosePrompt from './Lose/LosePrompt';
...
export default class Game extends React.Component {
  ...
  render() {
    console.log(hasLost);
    var RenderLosePrompt = hasLost ? <LosePrompt /> : <div />;
    return <div className="Game">{RenderLosePrompt}</div>;
  }
}
